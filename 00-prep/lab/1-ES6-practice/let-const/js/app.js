...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT -- Nate Vail: the console.log(rando) command threw an error because of the scope of `rando`. Since it is never defined via `let` outside of function `displayPics`, referencing it ouside the function will cause an error.
  console.log(viewed);
